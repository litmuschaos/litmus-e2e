...
describe("Testing the creation of dashboard", () => {
    ...
    it("Validate monitoring dashboard info", () => {
        ...
        cy.get("[data-cy=typeName]").should("have.text", configureDashboard.dashboardType);
        cy.get("[data-cy=dataSourceName]").should("have.text", configureDashboard.dataSource);
    ...
    it("Delete dashboard", () => {
        ...
        cy.get("[role=alert]").should("have.text", "Successfully deleted the dashboard");
