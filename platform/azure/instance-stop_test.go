...
var _ = Describe("BDD of azure-instance-stop experiment", func() {
	// BDD TEST CASE 1 - azure-instance-stop in parallel mode
	Context("Check for azure-instance-stop in parallel mode experiment", func() {
		It("Should check for the azure instance stop in parallel", func() {
	...
	// BDD TEST CASE 2 - azure-instance-stop in serial mode
	Context("Check for azure-instance-stop experiment", func() {

		It("Should check for the azure instance stop in serial", func() {
