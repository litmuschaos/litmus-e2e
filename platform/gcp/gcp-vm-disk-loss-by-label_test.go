...
func TestGoGCPVMDiskLossByLabel(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "BDD test")
}

//BDD for testing experiment
var _ = Describe("BDD of gcp-vm-disk-loss-by-label experiment", func() {

	// BDD TEST CASE 1 - gcp-vm-disk-loss-by-label in parallel mode
	Context("Check for gcp-vm-disk-loss-by-label experiment", func() {

		It("Should check for the gcp vm disk loss by label in parallel", func() {
			...
			testsDetails.ExperimentPath = "https://hub.litmuschaos.io/api/chaos/master?file=charts/gcp/gcp-vm-disk-loss-by-label/experiment.yaml"
			testsDetails.EnginePath = "https://hub.litmuschaos.io/api/chaos/master?file=charts/gcp/gcp-vm-disk-loss-by-label/engine.yaml"
	...
	// BDD TEST CASE 2 - gcp-vm-disk-loss-by-label in serial mode
	Context("Check for gcp-vm-disk-loss-by-label experiment", func() {

		It("Should check for the gcp vm disk loss by label in serial", func() {
