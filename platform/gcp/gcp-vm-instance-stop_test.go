...
var _ = Describe("BDD of gcp-vm-instance-stop experiment", func() {

	// BDD TEST CASE 1 - gcp-vm-instance-stop in parallel mode
	Context("Check for gcp-vm-instance-stop experiment", func() {
		It("Should check for the gcp vm instance stop in parallel", func() {
			...
			testsDetails.EnginePath = "https://hub.litmuschaos.io/api/chaos/master?file=charts/gcp/gcp-vm-instance-stop/engine.yaml"
	...
	// BDD TEST CASE 2 - gcp-vm-instance-stop in serial mode
	Context("Check for gcp-vm-instance-stop experiment", func() {

		It("Should check for the gcp vm instance stop in serial", func() {
