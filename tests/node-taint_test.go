...
func TestGoNodeTaint(t *testing.T) {
...
var _ = Describe("BDD of node-taint experiment", func() {
	...
	Context("Check for litmus components", func() {
		...
		It("Should check for creation of runner pod", func() {
			...
			Expect(err).To(BeNil(), "Failed to Cordon the app node due to {%v}", err)
		...
		It("Should uncordon the app node", func() {
			...
			Expect(err).To(BeNil(), "Failed to uncordon the app node due to {%v}", err)
