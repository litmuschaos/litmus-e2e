...
var _ = Describe("BDD of openebs experiment", func() {
	...
	Context("Check for the custom resources", func() {
		...
		It("Should check for creation of runner pod", func() {
			...
			err = exec.Command("kubectl", "apply", "-f", "https://raw.githubusercontent.com/litmuschaos/chaos-charts/master/charts/openebs/openebs-target-container-failure/rbac.yaml", "-n", "litmus").Run()
