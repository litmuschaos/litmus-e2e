...
var _ = Describe("BDD of openebs target network loss experiment", func() {
	...
	Context("Check for the openebs components", func() {
		...
		It("Should check for creation of runner pod", func() {
			...
			err = exec.Command("wget", "-O", "target-network-loss-ce.yml", "https://hub.litmuschaos.io/api/chaos?file=charts/openebs/openebs-target-network-loss/experiment.yaml").Run()
